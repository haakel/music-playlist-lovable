...
<div class="music-playlist-container <?php echo esc_attr($theme_class); ?>" id="<?php echo esc_attr($unique_id); ?>"
    ...
    <div class="music-playlist-player">
        ...
        <div class="music-playlist-cover">
            <?php 
                ...
                ?>
            <img src="<?php echo esc_url($cover_image); ?>" alt="<?php echo esc_attr($playlist->post_title); ?>"
                class="music-playlist-active-cover">
            <?php else : ?>
            <img src="<?php echo esc_url(MUSIC_PLAYLIST_PLUGIN_URL . 'assets/images/default-cover.png'); ?>"
                alt="<?php echo esc_attr($playlist->post_title); ?>" class="music-playlist-active-cover">
            <?php endif; ?>
        </div>
        <?php endif; ?>
        ...
        <div class="music-playlist-controls">
            ...
            <div class="music-playlist-buttons">
                <button class="music-playlist-prev"
                    aria-label="<?php echo esc_attr__('Previous track', 'music-playlist'); ?>">
                ...
                <button class="music-playlist-play"
                    aria-label="<?php echo esc_attr__('Play/Pause', 'music-playlist'); ?>">
                    <svg class="music-playlist-icon-play" width="24" height="24" viewBox="0 0 24 24" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path d="M8 5V19L19 12L8 5Z" fill="currentColor" />
                    </svg>
                    <svg class="music-playlist-icon-pause hidden" width="24" height="24" viewBox="0 0 24 24" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                ...
                <button class="music-playlist-next"
                    aria-label="<?php echo esc_attr__('Next track', 'music-playlist'); ?>">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="music-playlist-volume">
                    <button class="music-playlist-volume-toggle"
                        aria-label="<?php echo esc_attr__('Mute/Unmute', 'music-playlist'); ?>">
                        <svg class="music-playlist-icon-volume" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                        ...
                        <svg class="music-playlist-icon-mute hidden" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M3 10V14H7L12 19V5L7 10H3Z" fill="currentColor" />
                            <path d="M19 12L21 14L19 16L17 14L15 16L13 14L15 12L13 10L15 8L17 10L19 8L21 10L19 12Z"
                                fill="currentColor" />
                        </svg>
                    </button>
    ...
    <div class="music-playlist-playlist">
        ...
        <ul class="music-playlist-tracks">
            ...
            <li class="music-playlist-track <?php echo $index === 0 ? 'active' : ''; ?>"
                data-index="<?php echo esc_attr($index); ?>" data-id="<?php echo esc_attr($track['id']); ?>">
                <?php if (!empty($track['cover_image'])) : ?>
                <img src="<?php echo esc_url($track['cover_image']); ?>" alt="<?php echo esc_attr($track['title']); ?>"
                    class="music-playlist-track-cover">
                <?php else : ?>
                <img src="<?php echo esc_url(MUSIC_PLAYLIST_PLUGIN_URL . 'assets/images/default-cover.png'); ?>"
                    alt="<?php echo esc_attr($track['title']); ?>" class="music-playlist-track-cover">
                <?php endif; ?>
