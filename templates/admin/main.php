...
if ($selected_playlist_id) {
    $tracks = \MusicPlaylist\Database\Setup::getTracks($selected_playlist_id);
}
?>
    ...
    <div class="music-playlist-admin-container">
        <div class="music-playlist-admin-sidebar">
            <div class="music-playlist-admin-box">
                ...
                <a href="<?php echo esc_url(admin_url('post-new.php?post_type=music_playlist')); ?>" class="button button-primary">
                    <?php echo esc_html__('Add New Playlist', 'music-playlist'); ?>
                </a>
                
                <div class="music-playlist-list">
                    <?php if (empty($playlists)) : ?>
                        <p><?php echo esc_html__('No playlists found. Create your first playlist to get started.', 'music-playlist'); ?></p>
                    <?php else : ?>
                        <ul>
                            <?php foreach ($playlists as $playlist) : ?>
                                <li class="<?php echo $selected_playlist_id === $playlist->ID ? 'active' : ''; ?>">
                                    <a href="<?php echo esc_url(admin_url('admin.php?page=music-playlist&playlist_id=' . $playlist->ID)); ?>">
                                        <?php echo esc_html($playlist->post_title); ?>
                                    </a>
                                    <div class="playlist-actions">
                                        <a href="<?php echo esc_url(get_edit_post_link($playlist->ID)); ?>" title="<?php echo esc_attr__('Edit', 'music-playlist'); ?>">
                                            <span class="dashicons dashicons-edit"></span>
                                        </a>
                                        <a href="<?php echo esc_url(get_delete_post_link($playlist->ID)); ?>" title="<?php echo esc_attr__('Delete', 'music-playlist'); ?>" class="delete-playlist">
                ...
                <div class="music-playlist-shortcode-info">
                    ...
                    <?php if ($selected_playlist_id) : ?>
                        ...
                        <button class="button copy-shortcode" data-shortcode='[music_playlist id="<?php echo esc_attr($selected_playlist_id); ?>"]'>
        ...
        <div class="music-playlist-admin-content">
            <?php if ($selected_playlist_id) : ?>
                ...
                <div class="music-playlist-admin-box">
                    <h2><?php echo esc_html(sprintf(__('Manage Tracks: %s', 'music-playlist'), $playlist->post_title)); ?></h2>
                    ...
                    <div class="music-playlist-add-track">
                        ...
                        <form id="music-playlist-add-track-form">
                            ...
                            <div class="form-row">
                                <div class="form-field">
                                    <label for="track-file"><?php echo esc_html__('Audio File', 'music-playlist'); ?> *</label>
                                    <input type="text" id="track-file" name="file_url" class="regular-text" required readonly>
                                    <button type="button" id="select-audio-file" class="button">
                                        <?php echo esc_html__('Select File', 'music-playlist'); ?>
                                    </button>
                                    <p class="description"><?php echo esc_html__('Supported formats: MP3, WAV, OGG', 'music-playlist'); ?></p>
                                </div>
                            </div>
                            
                            <div class="form-row">
                                <div class="form-field">
                                    <label for="track-cover"><?php echo esc_html__('Cover Image', 'music-playlist'); ?></label>
                    ...
                    <div class="music-playlist-tracks">
                        ...
                        <?php if (empty($tracks)) : ?>
                            <p><?php echo esc_html__('No tracks in this playlist yet. Add your first track above.', 'music-playlist'); ?></p>
                        <?php else : ?>
                            <table class="wp-list-table widefat fixed striped" id="music-playlist-tracks-table">
                                <thead>
                                    <tr>
                                        <th scope="col" class="column-order"></th>
                                        <th scope="col" class="column-cover"><?php echo esc_html__('Cover', 'music-playlist'); ?></th>
                                        <th scope="col" class="column-title"><?php echo esc_html__('Title', 'music-playlist'); ?></th>
                                        <th scope="col" class="column-artist"><?php echo esc_html__('Artist', 'music-playlist'); ?></th>
                                        <th scope="col" class="column-actions"><?php echo esc_html__('Actions', 'music-playlist'); ?></th>
                                    </tr>
                                </thead>
                                        ...
                                        <tr data-id="<?php echo esc_attr($track['id']); ?>">
                                            ...
                                            <td class="column-cover">
                                                <?php if (!empty($track['cover_image'])) : ?>
                                                    <img src="<?php echo esc_url($track['cover_image']); ?>" alt="<?php echo esc_attr($track['title']); ?>" width="40" height="40">
                                                <?php else : ?>
                                                    <img src="<?php echo esc_url(MUSIC_PLAYLIST_PLUGIN_URL . 'assets/images/default-cover.png'); ?>" alt="<?php echo esc_attr($track['title']); ?>" width="40" height="40">
                                                <?php endif; ?>
                                            </td>
                                            ...
                                            <td class="column-actions">
                                                <button type="button" class="button play-track" data-file="<?php echo esc_url($track['file_url']); ?>">
                                                    <span class="dashicons dashicons-controls-play"></span>
                                                </button>
                                                <button type="button" class="button delete-track" data-id="<?php echo esc_attr($track['id']); ?>">
                                                    <span class="dashicons dashicons-trash"></span>
                                                </button>
                                            </td>
                                        </tr>
            ...
            <?php else : ?>
                <div class="music-playlist-admin-box">
                    ...
                    <p><?php echo esc_html__('Please select a playlist from the sidebar or create a new one to manage tracks.', 'music-playlist'); ?></p>
