...
class Admin
{
    ...
    {
        add_menu_page(
            __('Music Playlist', 'music-playlist'),
            __('Music Playlist', 'music-playlist'),
            'manage_options',
            'music-playlist',
    ...
    public function enqueueAssets($hook)
    {
        ...
        wp_enqueue_style(
            ...
            MUSIC_PLAYLIST_PLUGIN_URL . 'assets/css/admin.css',
            [],
        ...
        wp_enqueue_script(
            'music-playlist-admin',
            MUSIC_PLAYLIST_PLUGIN_URL . 'assets/js/admin.js',
    ...
    {
        include MUSIC_PLAYLIST_PLUGIN_DIR . 'templates/admin/main.php';
    }
