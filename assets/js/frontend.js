...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const playlistContainers = document.querySelectorAll('.music-playlist-container');
    ...
    playlistContainers.forEach(function(container) {
        ...
        const currentTimeDisplay = container.querySelector('.music-playlist-time-current');
        const totalTimeDisplay = container.querySelector('.music-playlist-time-total');
        const tracks = container.querySelectorAll('.music-playlist-track');
        const volumeToggle = container.querySelector('.music-playlist-volume-toggle');
        const volumeSlider = container.querySelector('.music-playlist-volume-slider');
        const volumeProgress = container.querySelector('.music-playlist-volume-progress');
        ...
        function loadTrack(index) {
            ...
            // Update track info
            const titleElement = container.querySelector('.music-playlist-player .music-playlist-track-title');
            const artistElement = container.querySelector('.music-playlist-player .music-playlist-track-artist');
            ...
            if (coverElement) {
                if (track.cover_image) {
                    ...
                    // Set default cover
                    coverElement.src = '../wp-content/plugins/music-playlist/assets/images/default-cover.png';
                }
            }
